...
def display_customer_wallet_info(coins_quantity, total_value):
    ...
    print(f'You have {coins_quantity[2]} Nickels')
    print(f'You have {coins_quantity[3]} Pennies')
...
def display_can_cost(selected_can_name, selected_can_price):
    """Displays the name of a can and its price"""
    print(f'The price of a {selected_can_name} is ${selected_can_price}')
