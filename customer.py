...
class Customer:
    ...
    def gather_coins_from_wallet(self, selected_soda_name, selected_soda_price):
        ...
        while will_proceed == False:
            user_interface.display_can_cost(selected_soda_name, selected_soda_price)
    ...
    def add_coins_to_wallet(self, coins_list):
        ...
        self.wallet.money.extend(coins_list)
